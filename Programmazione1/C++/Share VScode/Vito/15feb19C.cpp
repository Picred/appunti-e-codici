...
int main(){
    ...
    //si calcoli la media dei valori elab(3) per tutti gli oggetti della collezione e si visualizzi la stringa
    // concatenazione di tutte le stringhe restituite da g(’h’) per tutti gli oggetti di tipo C
    ...
    cout<< endl <<"PUNTO 2"<<endl;
        ...
        for (int i=0; i<DIM; i++){
            ...
            if(typeid(*vett[i])==typeid(C)) 
                risultato+=((C*)vett[i])->g('h');
        }
        media/=DIM;
        cout << "Avg= " << media << "concat="<<risultato<<endl;
