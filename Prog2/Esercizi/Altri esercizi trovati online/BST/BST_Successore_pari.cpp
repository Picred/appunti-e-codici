...
sia in grado di stampare tutti i nodi dell'albero, seguendo una visita postorder dello stesso
stampando esclusivamente i soli nodi la cui chiave contenuta nel nodo successore abbia la parte intera pari. 
Se il nodo non ha successore allora non dovrà essere stampato in output.
*/
...
private:
    ...
    void _postorder(ostream& os, Nodo<T>* r){
        ...
        Nodo<T>* s = _successore(r);
        if(s && int(s->getKey())%2 == 0) os << r->getKey() << " ";
    }
