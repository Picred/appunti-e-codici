...
class List{
    ...
    public:
        ...
        void insertInOrder(T val){//inserimento ordinato
            ...
            while(ptr->getNext() && (val >= ptr->val )) { //scorro la lista finchè il successivo non è nullptr e finchè 
        ...
        //Esercizio: scrivere metodo per inserire in ordine crescente e decrescente 
        ...
        void insertDecrescente(T val){
            ...
            Node<T>* ptr=head; //ptr per scorrere
